...
import { BookOpen, Users, Zap, UserCheck, Coins, Lightbulb, ArrowRight, Play, CheckCircle, Sparkles, Target, Globe, Shield } from 'lucide-react'
      ...
      <section className="relative z-10 pt-32 pb-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <Button 
            variant="outline" 
            size="lg" 
            className="px-8 py-4 rounded-full text-lg bradley-hand-bold border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white transition-all duration-300"
          >
              ...
              <div key={feature.id} className="mb-32">
                ...
                {index < features.length - 1 && (
                  <div className="text-center mt-16">
                    {user ? (
                      <Button asChild size="lg" className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-full text-lg bradley-hand-bold">
                        <Link href="/dashboard">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 bradley-hand-bold">
              Ready to start your
              <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent"> learning journey?</span>
            </h2>
            
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto bradley-hand">
              Join thousands of learners and educators who are already transforming 
              their skills with PeerVerse.
            </p>
